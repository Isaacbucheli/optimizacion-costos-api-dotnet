...
{
    [Fact]
    public void Catalogo_tiene_15_modulos_con_claves_unicas()
    {
        Assert.Equal(15, Modules.All.Count);
    ...
    public void Claves_coinciden_con_las_secciones_del_front()
    {
        ...
        [
            ...
            "waf-cost", "report", "boletin", "reservations", "alerts", "policies", "consultants", "access-review",
