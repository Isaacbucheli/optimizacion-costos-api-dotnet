...
/// los pierde, ni antes de guardar ni después: si se le pasa una fila recién parseada, los propaga
/// intactos, y <c>SqlInformeValorStore.GetRbacAsync</c> reconstruye <see cref="RbacRow"/> desde sus
/// propias columnas (<c>role_class</c>/<c>is_custom_role</c>), no desde valores fijos. Un
/// <see cref="RbacFila"/> construido después de un ciclo completo de guardar-y-releer trae la
/// misma clase que calculó el parser.</para>
///
